class GeneticBanksController < ApplicationController
  ...
  private
    ...
    def genetic_bank_params
      params.require(:genetic_bank).permit(:codeBreeder, :breeder, :analysedYear, :status, :variety, :numPlants,:picture, :color_id, :scent, :headSize, :petals, :steamLength, :production, :opening, :flowerAbnormality, :sheets, :hawthorn, :relationship, :remarks)
    end
end
