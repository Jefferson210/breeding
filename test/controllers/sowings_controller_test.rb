...
class SowingsControllerTest < ActionController::TestCase
  ...
  test "should create sowing" do
    assert_difference('Sowing.count') do
      post :create, sowing: { calendar: @sowing.calendar, hydratation: @sowing.hydratation, numSeed: @sowing.numSeed, origin: @sowing.origin, week.integer: @sowing.week.integer, weight: @sowing.weight }
    end
  ...
  test "should update sowing" do
    patch :update, id: @sowing, sowing: { calendar: @sowing.calendar, hydratation: @sowing.hydratation, numSeed: @sowing.numSeed, origin: @sowing.origin, week.integer: @sowing.week.integer, weight: @sowing.weight }
    assert_redirected_to sowing_path(assigns(:sowing))
  end
